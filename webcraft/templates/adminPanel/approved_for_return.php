<?php
    ...
    $query = "SELECT ar.unit_ID, ar.report_issue, ar.problem_desc, ar.unit_img, ar.user_ID, ar.timestamp, e.article, e.deployment, e.property_number, e.account_code, e.image, u.first_name, u.middle_initial, u.last_name
    ...
    $stmt->execute();
    $stmt->bind_result($unitID, $reportIssue, $problemDesc, $unitImg, $user_ID, $timestamp, $article, $deployment, $propertyNumber, $accountCode, $image, $firstName, $middleIntial, $lastName);
    $stmt->fetch();
    if ($timestamp !== null) {
        ...
        <div class="sideBarContainer3">
            ...
            <div class="subContainer1" id="containerToReplace">
                ...
                <div class="filterContainer1" style="width: 100%; margin-top: 0rem;">
                    ...
                    <form class="subViewApproveContainer" action="../../functions/restore_unit.php" enctype="multipart/form-data" method="post">
